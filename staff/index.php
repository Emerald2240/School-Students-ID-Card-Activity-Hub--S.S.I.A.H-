                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                                            ...
                                            <h4 class="mb-0 fw-bold "><?= count(getAllStudentsScannedPerLecturer($_SESSION['staff_id'])) ?></h4>
                                        </div>
                                        <div class="card-body">
                                    ...
                                    <div class="card bg-primary">
                                        <div class="card-body row">
                                            <div class="col">
                                                ...
                                                <h1 class="mt-3 mb-0 fw-bold text-white"><?= count(getAllJobEntriesForStaff($_SESSION['staff_id'])) ?></h1>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center flex-fill">
                                                ...
                                                <div class="d-flex flex-column ps-3  flex-fill">
                                                    <h6 class="fw-bold mb-0 fs-4"><?= getEntryValidity(getAllJobEntriesForStaff($_SESSION['staff_id']), true) ?></h6>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center flex-fill">
                                                ...
                                                <div class="d-flex flex-column ps-3 flex-fill">
                                                    <h6 class="fw-bold mb-0 fs-4"><?= getEntryValidity(getAllJobEntriesForStaff($_SESSION['staff_id']), false) ?></h6>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="flex-grow-1">
                                                <?php
                                                $count = 0;
                                                $scannedStudents = getAllStudentsScannedPerLecturer($_SESSION['staff_id']);
